...
- If you want to reuse existing Azure resources, check the **[Local dev using an existing model](#local-development-using-an-existing-gpt-4o-mini-and-ada-002-model)** section.
...
To use these services, check the `program.cs` for these lines, where the Azure OpenAI client definition is loaded:
